...
from src.frames_utility import generate_paddle_frames, generate_ball_frames, generate_brick_frames, generate_powerups_frames
...
SOUNDS = {
    ...
    'high_score': pygame.mixer.Sound(
        BASE_DIR / "sounds/high_score.wav"),
    'life': pygame.mixer.Sound(
        BASE_DIR / "sounds/life.wav"),
    'grow_up': pygame.mixer.Sound(
        BASE_DIR / "sounds/grow_up.wav"),
    'pause': pygame.mixer.Sound(
        BASE_DIR / "sounds/pause.wav"),
}
