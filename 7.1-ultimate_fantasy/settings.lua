...
TEXTURES = {
    ...
    ['cursor-right'] = love.graphics.newImage('assets/graphics/cursor_right.png'),
    ['cursor-up'] = love.graphics.newImage('assets/graphics/cursor_up.png'),
    ['healer-female'] = love.graphics.newImage('assets/graphics/characters/healer_f.png'),
    ['healer-male'] = love.graphics.newImage('assets/graphics/characters/healer_m.png'),
    ['mage-female'] = love.graphics.newImage('assets/graphics/characters/mage_f.png'),
    ['mage-male'] = love.graphics.newImage('assets/graphics/characters/mage_m.png'),
    ['warrior-female'] = love.graphics.newImage('assets/graphics/characters/warrior_f.png'),
    ['warrior-male'] = love.graphics.newImage('assets/graphics/characters/warrior_m.png'),
    ['ranger-female'] = love.graphics.newImage('assets/graphics/characters/ranger_f.png'),
    ['ranger-male'] = love.graphics.newImage('assets/graphics/characters/ranger_m.png'),
    ['npc-female'] = love.graphics.newImage('assets/graphics/characters/townfolk_f.png'),
    ['npc-male'] = love.graphics.newImage('assets/graphics/characters/townfolk_m.png'),
    ['slime'] = love.graphics.newImage('assets/graphics/enemies/slime.png'),
    ['small-worm'] = love.graphics.newImage('assets/graphics/enemies/small_worm.png'),
    ['snake'] = love.graphics.newImage('assets/graphics/enemies/snake.png'),
    ['pumpking'] = love.graphics.newImage('assets/graphics/enemies/pumpking.png'),
    ['man-eater-flower'] = love.graphics.newImage('assets/graphics/enemies/man_eater_flower.png')
}
...
FONTS = {
    ...
    ['ff'] = love.graphics.newFont('assets/fonts/finalf.ttf', 48),
    ['ff-small'] = love.graphics.newFont('assets/fonts/finalf.ttf', 24)
}

SOUNDS = {
    ['intro'] = love.audio.newSource('assets/sounds/intro.mp3', 'static'),
    ['town'] = love.audio.newSource('assets/sounds/town.mp3', 'static'),
    ['world'] = love.audio.newSource('assets/sounds/world.mp3', 'static'),
    ['blip'] = love.audio.newSource('assets/sounds/blip.wav', 'static'),
    ['battle'] = love.audio.newSource('assets/sounds/battle.mp3', 'static'),
    ...
    ['arrows'] = love.audio.newSource('assets/sounds/arrows.wav', 'static'),
    ['flame'] = love.audio.newSource('assets/sounds/flame.ogg', 'static'),
    ['game-over'] = love.audio.newSource('assets/sounds/game_over.mp3', 'static'),
    ...
    ['the-end'] = love.audio.newSource('assets/sounds/the_end.mp3', 'static')
}
