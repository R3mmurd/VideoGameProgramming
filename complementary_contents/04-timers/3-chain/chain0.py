...
class ChainGame(Game):
    ...
    def init(self) -> None:
        ...
        self.destinations = (
            {"left": WINDOW_WIDTH - self.SQUARE_SIZE, "top": 0, "reached": False},
            {
                "left": WINDOW_WIDTH - self.SQUARE_SIZE,
                "top": WINDOW_HEIGHT - self.SQUARE_SIZE,
                "reached": False,
            },
            {"left": 0, "top": WINDOW_HEIGHT - self.SQUARE_SIZE, "reached": False},
    ...
    def update(self, dt: float) -> None:
        ...
        for d in self.destinations:
            ...
            self.rect.top = (
                self.base_top + (d["top"] - self.base_top) * self.timer / MOVEMENT_TIME
            )
