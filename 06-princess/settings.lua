...
TEXTURES = {
    ...
    ['character-pot-lift'] = love.graphics.newImage('assets/graphics/character_pot_lift.png'),
    ['character-pot-walk'] = love.graphics.newImage('assets/graphics/character_pot_walk.png')
}
